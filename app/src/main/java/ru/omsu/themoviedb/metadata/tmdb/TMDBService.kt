...
interface TMDBService {
    ...
    fun getVideosMovie(@Path("movie_id") movieId: Int,
                       @Query("api_key") apiKey: String,
                       @Query("language") language: String?): Observable<Videos>

    @GET("movie/{movie_id}/credits")
    fun getCreditsMovie(@Path("movie_id") movieId: Int,
                        @Query("api_key") apiKey: String): Observable<Credits>

    @GET("tv/popular")
    fun getPopularTV(@Query("api_key") apiKey: String,
                     @Query("language") language: String,
                     @Query("page") page: Int): Observable<Page<TVShow>>

    @GET("tv/top_rated")
    fun getTopRatedTV(@Query("api_key") apiKey: String,
                      @Query("language") language: String?,
                      @Query("page") page: Int): Observable<Page<TVShow>>

    @GET("tv/latest")
    fun getLatestTV(@Query("api_key") apiKey: String,
                    @Query("language") language: String?,
                    @Query("page") page: Int): Observable<Page<TVShow>>


    @GET("search/tv")
    fun getSearchTVShows(@Query("api_key") apiKey: String,
                         @Query("language") language: String?,
                         @Query("query") query: String,
                         @Query("page") page: Int): Observable<Page<TVShow>>

    @GET("tv/{tvshow_id}")
    fun getTVshowDetails(@Path("tvshow_id") tvshowId: Int,
                         @Query("api_key") apiKey: String,
                         @Query("language") language: String?): Observable<TVShow>

    @GET("tv/{tvshow_id}/season/{season_number}")
    fun getSeasonDetails(@Path("tvshow_id") tvshowId: Int,
                         @Path("season_number") seasonNumber: Int,
                         @Query("api_key") apiKey: String,
                         @Query("language") language: String?): Observable<Season>

    @GET("tv/{tvshow_id}/season/{season_number}/episode/{episode_number}")
    fun getEpisodeDetails(@Path("tvshow_id") tvshowId: Int,
                          @Path("season_number") seasonNumber: Int,
    ...
    fun getVideosTVShow(@Path("tvshow_id") tvshowId: Int,
                        @Query("api_key") apiKey: String,
                        @Query("language") language: String?): Observable<Videos>
    ...
    fun getCreditsTVShow(@Path("tvshow_id") tvshowId: Int,
                         @Query("api_key") apiKey: String): Observable<Credits>

    @GET("collection/{collection_id}")
    fun getCollectionDetails(@Path("collection_id") collectionId: Int,
                             @Query("api_key") apiKey: String,
